  ...
  return (
    <form className="min-w-md flex flex-col gap-2" action="">
        ...
        <div className="flex flex-col gap-2 mt-4">
            <input className="border border-zinc-300 p-1" type="submit" value="Login" />
            <Link className="border border-zinc-300 p-1 text-center" href="/signup">Belum punya akun?</Link>
        </div>
    </form>
  )
}
