...
const SignupForm: FC = () => {
  ...
  return (
    <form className='flex min-w-md flex-col gap-2' action={action}>
      ...
      <div className='flex flex-col'>
        <label className='text-sm text-zinc-700' htmlFor='confirmPassword'>
          Confirm Password
        </label>
        <input
          className='border border-zinc-300 p-1'
      ...
      <div className='mt-4 flex flex-col gap-2'>
        <input
          className='border border-zinc-300 p-1 disabled:opacity-5'
          type='submit'
          value='Daftar'
          disabled={pending}
        />
        <Link className='border border-zinc-300 p-1 text-center' href='/login'>
          Sudah punya akun?
        </Link>
      </div>
    </form>
